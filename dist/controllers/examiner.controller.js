...
export const submitScore = async (req, res, next) => {
    try {
        ...
        const validScores = Object.values(scores).every(s => s >= 1 && s <= 12);
        if (!validScores) {
        ...
        if (!result) {
            ...
            if (session.writingResponses.length > 0)
                result.writingBand = scoreData;
...
//# sourceMappingURL=examiner.controller.js.map