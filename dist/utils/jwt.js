...
// SIGN TOKENS
// ============================================
export function signUserAccessToken(userId, email, role, schoolId, name) {
    const payload = { userId, email, role, schoolId, name };
...
export async function signUserRefreshToken(userId) {
...
export async function verifyUserRefreshToken(token) {
    try {
