/**
 * Patch Test Set 6 — Listening Part 1 → Farmers Market (3-3-2).
 * Usage: npx tsx src/scripts/patch-listening-set6-part1-market.ts
 */
...
import { LISTENING_SET6_PART1_MCQS } from '../seeds/listening/questions/set6/part1.js';
...
const updated = await QuestionBank.findOneAndUpdate(
  { module: 'listening', testSetNumber: 6, taskNumber: 1 },
  {
    $set: {
      module: 'listening',
      testSetNumber: 6,
      ...
      instructions:
        'You will hear a conversation between a man and a woman at a farmers market. The woman sells preserves at a stall and the man is a customer.',
      ...
      allowSeek: true,
      playLimit: 0,
      mcqs: LISTENING_SET6_PART1_MCQS,
    },
  },
  { new: true, upsert: true },
);

await clearCachedQuestions(6);

console.log('Test 6 Part 1 updated: Farmers Market (3-3-2)');
