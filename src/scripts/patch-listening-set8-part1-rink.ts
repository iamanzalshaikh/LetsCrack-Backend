/**
 * Patch Test Set 8 — Listening Part 1 → Community Skating Rink (3-3-2).
 * Usage: npx tsx src/scripts/patch-listening-set8-part1-rink.ts
 */
...
import { LISTENING_SET8_PART1_MCQS } from '../seeds/listening/questions/set8/part1.js';
...
const updated = await QuestionBank.findOneAndUpdate(
  { module: 'listening', testSetNumber: 8, taskNumber: 1 },
  {
    $set: {
      module: 'listening',
      testSetNumber: 8,
      ...
      instructions:
        'You will hear a conversation between a man and a woman at a community skating rink. The woman works at the rental counter and the man is a visitor.',
      ...
      allowSeek: true,
      playLimit: 0,
      mcqs: LISTENING_SET8_PART1_MCQS,
    },
  },
  { new: true, upsert: true },
);

await clearCachedQuestions(8);

console.log('Test 8 Part 1 updated: Community Skating Rink (3-3-2)');
